...
export const Count = ({ editor, limit }: { editor: Editor, limit?: number }) => {
    ...
    return (
        <div
            className={`character-count !border-t !border-border p-3 ${charactersCount === limit ? 'character-count--warning' : ''
                }`}
        >
